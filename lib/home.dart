  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: listsLocatorHome<ListsCRUD>()),
      ],
      child: Scaffold(
...
String _userIDSelectedTest = "";
  ...
  Widget build(BuildContext context) {
    ...
    final listProvider = Provider.of<ListsCRUD>(context);
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ListsPage(listProvider: listProvider, userDocuments: userDocuments, profileEmail: _profileEmail)),
                  );
                  // }
